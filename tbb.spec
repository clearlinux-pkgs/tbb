...
export LANG=C
export SOURCE_DATE_EPOCH=1530721092
export AR=gcc-ar
...
export SOURCE_DATE_EPOCH=1530721092
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/tbb
cp LICENSE %{buildroot}/usr/share/doc/tbb/LICENSE
%make_install
