...
Source0  : https://github.com/oneapi-src/oneTBB/archive/v2021.13.0/oneTBB-2021.13.0.tar.gz
...
%prep
%setup -q -n oneTBB-2021.13.0
cd %{_builddir}/oneTBB-2021.13.0
pushd ..
cp -a oneTBB-2021.13.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720026441
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libtbb.so.12.13
/V3/usr/lib64/libtbbbind_2_5.so.3.13
/V3/usr/lib64/libtbbmalloc.so.2.13
/V3/usr/lib64/libtbbmalloc_proxy.so.2.13
